# This Directory contains task to integrate a robost database server
...
<b>Make sure that UFW is allowing connections on port 3306 (default MySQL port) otherwise replication will not work.</>
Example:
